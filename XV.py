...
""")
    ...
    if len(nama)<6:
        ...
        if len(depan)<3:
            pasw.append(nama)
            pasw.append(nama+"123")
            pasw.append(nama+"12345")
            pasw.append(nama+"@123")
            pasw.append(nama+"2023")
        else:
            pasw.append(nama)
            pasw.append(depan+"123")
            pasw.append(depan+"12345")
            ...
            pasw.append(depan+"01")
            pasw.append(depan+"09")
            pasw.append("sayang123")
            pasw.append("bismillah")
            pasw.append("kontol123")
            pasw.append("123456")
            pasw.append("rahasia123")
            pasw.append("indonesia123")
				if 'Api' in method:
